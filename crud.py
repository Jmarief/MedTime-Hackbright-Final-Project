...
def create_user(fname, lname, email, phone_number, password):
    ...
    user = User(fname=fname, lname=lname, email=email, phone_number=phone_number, password=password)
...
def create_medications(medication_name, instructions, medication_allergies):
    """create and return medications"""

    medications = Medications(medication_name=medication_name, instructions=instructions,
...
def create_reminders(user_id, medication_id, scheduled_date, scheduled_time,
                     intake_alarm, refills):
    """Create and return reminders"""

    reminder = Reminders(user_medications_id=user_id, medication_id=medication_id,
